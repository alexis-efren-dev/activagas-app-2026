...
const DashboardAccounting: React.FC<IDashboardAccounting> = ({
  navigation,
}): JSX.Element => {
  return (
      ...
      <KeyboardAwareScrollView
        ...
        <View style={styles.header}>
          <View style={styles.headerIconContainer}>
            <Icon name="cash-register" size={36} color="#1C9ADD" />
          </View>
          <Text style={styles.headerTitle}>Cobranza</Text>
          <Text style={styles.headerSubtitle}>
            Gestiona pagos y usuarios del sistema
          </Text>
        </View>
        ...
        <View style={styles.content}>
          <ActionButton
            ...
            label="Pagar"
            subtitle="Registrar pago de cliente"
          ...
          <ActionButton
            icon="account-edit"
            label="Editar"
            subtitle="Modificar datos de usuario"
        ...
        <View style={styles.footerBadge}>
          ...
          <Text style={styles.footerBadgeText}>Sistema de Cobranza</Text>
        </View>
      </KeyboardAwareScrollView>
    </LinearGradient>
  );
